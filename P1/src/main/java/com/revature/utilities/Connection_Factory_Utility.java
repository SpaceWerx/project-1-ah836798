...
public class Connection_Factory_Utility {
	
    private static Connection_Factory_Utility instance;

    private Connection_Factory_Utility() {
        super();
    }
    ...
    public static Connection_Factory_Utility getInstance() {
        if(instance == null) {
            instance = new Connection_Factory_Utility();
        }
